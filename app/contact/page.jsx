...
const Contact = () => {
  ...
  if (isThankYouVisible) {
    return (
      <div className="flex items-center justify-center h-screen bg-[#27272c] text-accent">
          ...
          <div className="xl:h-[54%] order-2 xl:order-none">
            <form className="flex flex-col gap-6 p-10 bg-[#27272c] rounded-xl">
              ...
              <p className="text-white/60">
                ...
                let's discuss how we can bring your ideas to life. I’d love to
                hear from you!
              </p>
              {/* input */}
              ...
              />
              {/* btn */}
              <Button size="md" className="max-w-40" onClick={handleSendMessage}>
                Send message
              </Button>
            </form>
          </div>
